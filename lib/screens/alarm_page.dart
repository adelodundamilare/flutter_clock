...
import 'package:flutter_clock_sample/alarm_helper.dart';
import 'package:flutter_clock_sample/constants/theme_data.dart';
import 'package:flutter_clock_sample/main.dart';
...
class _AlarmPageState extends State<AlarmPage> {
                  ...
                  return ListView(
                    children: snapshot.data!.map<Widget>((alarm) {
                      var alarmTime = DateFormat('hh:mm aa')
                          .format(alarm.alarmDateTime ?? DateTime.now());
                      ...
                      if (_currentAlarms != null && _currentAlarms!.length < 5)
                        DottedBorder(
                          strokeWidth: 2,
  ...
  void scheduleAlarm(
      dynamic scheduledNotificationDateTime, AlarmInfo alarmInfo) async {
